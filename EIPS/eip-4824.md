...
Contract Registry JSON-LD Schema.
...
The contract registry JSON is intended to enable DAOs to label other relevant contracts to their DAO. This may include treasuries, governance tokens, badging contracts, logic contracts, upgradeable proxies, and more.
